...
public final class Auth {
  ...
  public static String AccessKey = "__rddnUwKkJ3b_wefxE4LX2MpgHS7h9UMADeIgtO";//AccessKey
  public static String SecretKey = "nUlcM_FBTDa05VnfIErODNtMqMa3X6cDUsuFAXZX";//SecretKey

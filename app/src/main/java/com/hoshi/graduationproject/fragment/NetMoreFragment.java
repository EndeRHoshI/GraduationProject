...
import com.hoshi.graduationproject.activity.AlbumsDetailActivity;
import com.hoshi.graduationproject.activity.ArtistDetailActivity;
import com.hoshi.graduationproject.adapter.MusicFlowAdapter;
import com.hoshi.graduationproject.adapter.OverFlowAdapter;
import com.hoshi.graduationproject.adapter.OverFlowItem;
import com.hoshi.graduationproject.dialog.AddNetPlaylistDialog;
...
import com.hoshi.graduationproject.json.SearchAlbumInfo;
import com.hoshi.graduationproject.json.SearchArtistInfo;
...
import com.hoshi.graduationproject.widget.DividerItemDecoration;
            ...
            new AlertDialog.Builder(mContext).setTitle("要下载音乐吗").
                    setPositiveButton(mContext.getString(R.string.sure), new DialogInterface.OnClickListener() {
                      ...
                      public void onClick(DialogInterface dialog, int which) {
                        Down.downMusic(MyApplication.getContext(), adapterMusicInfo.songId + "", adapterMusicInfo.musicName, adapterMusicInfo.artist);
                        dialog.dismiss();
                      }
                    }).
                ...
                protected Void doInBackground(Void... params) {
                  ...
                  try {
                    ...
                    for (JsonElement o : artistArray) {
                      SearchArtistInfo artistInfo = MyApplication.gsonInstance().fromJson(o, SearchArtistInfo.class);
...
//                                        }
                    ...
                    for (JsonElement o : albumArray) {
                      SearchAlbumInfo albumInfo = MyApplication.gsonInstance().fromJson(o, SearchAlbumInfo.class);

...
import com.hoshi.graduationproject.dialog.LoadAllDownInfos;
import com.hoshi.graduationproject.fragment.MoreFragment;
import com.hoshi.graduationproject.fragment.NetMoreFragment;
import com.hoshi.graduationproject.handler.HandlerUtil;
import com.hoshi.graduationproject.info.MusicInfo;
import com.hoshi.graduationproject.json.AlbumInfo;
import com.hoshi.graduationproject.json.GeDanGeInfo;
...
import com.hoshi.graduationproject.net.MusicDetailInfoGet;
import com.hoshi.graduationproject.net.NetworkUtils;
import com.hoshi.graduationproject.net.RequestThreadPool;
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder itemHolder, final int i) {
            if (itemHolder instanceof ItemViewHolder) {
                ...
                if (MusicPlayer.getCurrentAudioId() == localItem.songId) {
                    ...
                    ((ItemViewHolder) itemHolder).playState.setImageTintList(R.color.theme_color);
                } else {

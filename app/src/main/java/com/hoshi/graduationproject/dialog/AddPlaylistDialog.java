package com.hoshi.graduationproject.dialog;
...
import com.hoshi.graduationproject.info.Playlist;
import com.hoshi.graduationproject.provider.PlaylistInfo;
import com.hoshi.graduationproject.provider.PlaylistsManager;
import com.hoshi.graduationproject.service.MusicTrack;
                    ...
                    public void onClick(View v) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (long id : musicId) {
                                    albumart = MusicUtils.getAlbumdata(MyApplication.getContext(), id);
                                    if (albumart != null) {
                                        break;
                                    }
                                }
                                ...
                                for (int i = 0; i < musicId.length; i++) {
                                    playlistsManager.insert(MyApplication.getContext(), editText.getText().hashCode(), musicId[i], i);
                                }

...
import com.hoshi.graduationproject.adapter.FragmentAdapter;
import com.hoshi.graduationproject.constants.Extras;
import com.hoshi.graduationproject.constants.Keys;
import com.hoshi.graduationproject.executor.ControlPanel;
...
public class MusicActivity extends BaseActivity implements View.OnClickListener, QuitTimer.OnTimerListener,
  ...
  private LocalMusicChildFragment mLocalMusicFragment;
  ...
  private void setupView() {
    ...
    // setup view pager
    mLocalMusicFragment = new LocalMusicChildFragment();
